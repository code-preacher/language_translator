...
<?php
include '../config.php';
$qt=mysqli_query($con,"select * from suggestion where sender='".$_SESSION['email']."' ");
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                  <a href="translate.php">  <span><i class="fa fa-book f-s-50 color-success"></i></span></a>
                                </div>
                                <div class="media-body media-text-right">
                                    <p></p>
                                    <p class="m-b-0"><a href="translate.php">Translate Now</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
