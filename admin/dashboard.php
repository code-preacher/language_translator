...
$q3=mysqli_query($con,"select * from translation  ");
...
include "inc/sidebar.php";
 ...
 <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                   <a href="view.php"> <span><i class="fa fa-book f-s-50 color-success"></i></span></a>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2>
                                        <?php 
                                    ...
                                    <p class="m-b-0"><a href="view.php">Total Words</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
